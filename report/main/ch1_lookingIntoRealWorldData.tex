...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/BNP_Paribas_fitted}
...
\end{figure}
\paragraph{}
The curves are skewed to the right (it is particularly obvious in the case of the Sanofi stock). It corresponds to the case $\xi > 0$ in the generalised extreme value distribution representation or, equivalently, to a Fréchet-type distribution.
\clearpage
...
\end{figure}
\paragraph{}
The data-above-threshold plots for the Carrefour and Total stocks show that the data seems to fit a Gumbel distribution (corresponds to the case $\xi = 0$ in the generalised extreme value distribution representation).
\clearpage

...
\end{figure}
\paragraph{}
All those curves are skewed to the right, and the shape parameter is negative in each case. It corresponds to the case $\gamma > 0$ in the generalised extreme value distribution representation $G_\gamma$, or equivalently, to a Fréchet-type distribution.
\clearpage

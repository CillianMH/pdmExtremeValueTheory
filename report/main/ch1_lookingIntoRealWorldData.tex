...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/aboveThresholdData.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.9]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/BNP_Paribas_fitted}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/Sanofi_fitted}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/Carrefour_fitted}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/Total_fitted}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/LVMH_fitted}
	\caption{Density fitting for the LVMH data - 95 \% quantile \\}
	\label{fig:dataAboveThresholdLVMHFitted}
\end{figure}
\paragraph{LVMH stock - 97.5 \% quantile}
\begin{figure}[h!]
	\centering
	\includegraphics[scale = 0.8]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/LVMH_fitted2}
...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_BNP.png}
		\label{fig:QQBNP1}
	\end{minipage}
	~
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_BNP2.png}
		\label{fig:QQBNP2}
	\end{minipage}
...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_Carrefour.png}
		\label{fig:QQCarrefour1}
	\end{minipage}
	~
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_Carrefour2.png}
...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_LVMH.png}
		\label{fig:QQLVMH1}
	\end{minipage}
	~
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_LVMH2.png}
		\label{fig:QQLVMH2}
	\end{minipage}
...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_Sanofi.png}
		\label{fig:QQSanofi1}
	\end{minipage}
	~
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_Sanofi2.png}
		\label{fig:QQSanofi2}
	\end{minipage}
...
\begin{figure}[h!]
	...
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_Total.png}
		\label{fig:QQTotal1}
	\end{minipage}
	~
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[scale = 0.35]{/Users/kimartin/Desktop/PDM_github_repo/pdmExtremeValueTheory/r_files_tache8/QQ_Total2.png}
		\label{fig:QQTotal2}
	\end{minipage}

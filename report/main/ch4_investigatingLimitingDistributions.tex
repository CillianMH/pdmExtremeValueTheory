...
\section{What are the limiting distributions in theses cases ?\footnote{In what follows we are using theoretical results exposed in the next chapter, chapter 3, concerning the three possible limiting distributions as well as Von Mises' theorem.}}

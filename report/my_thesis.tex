...
\include{main/ch4_investigatingLimitingDistributions}
\include{main/ch1_theExtremalProblems}
\include{main/ch1_lookingIntoRealWorldData}
\include{main/conclusion}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% TAIL: Bibliography, Appendix, CV
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{tail/appendixDerivations}
\backmatter
\include{tail/additionalFigures}
\backmatter
\include{tail/appendix}
\backmatter
\include{tail/appendixOpinion}
%\include{tail/biblio}

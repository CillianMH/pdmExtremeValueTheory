...
\subsection*{The extremal limit problem}
\subsubsection*{Introduction}
Hereafter are set forth the derivations for the part on the limiting distributions.
...
\subsubsection*{Solving the problem - step 2 : expliciting the $G_\gamma$ in earnest}
